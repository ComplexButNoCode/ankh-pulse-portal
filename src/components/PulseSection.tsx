      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <div className="cosmic-blur rounded-3xl p-8">
            <h3 className="text-subtitle mb-6 text-foreground">O QUE SOMOS</h3>
            <div className="space-y-4 text-body text-aurora-200">
              <p>
          ...
          <div className="cosmic-blur rounded-3xl p-8">
            <h3 className="text-subtitle mb-6 text-foreground">NOSSOS CLUBS</h3>
            <div className="space-y-4 text-body text-aurora-200">
              <p>
          ...
          <div className="cosmic-blur rounded-3xl p-8">
            <h3 className="text-subtitle mb-6 text-foreground">STREAMING</h3>
            <div className="space-y-4 text-body text-aurora-200">
              <p>
          ...
          <div className="cosmic-blur rounded-3xl p-8">
            <h3 className="text-subtitle mb-6 text-foreground">PRODUÇÃO</h3>
            <div className="space-y-4 text-body text-aurora-200">
              <p>
        ...
        <div className="text-center">
          <div className="cosmic-blur rounded-3xl p-12 max-w-4xl mx-auto">
            ...
            <h3 className="text-title mb-8 text-foreground">NOSSA FILOSOFIA</h3>
            <p className="text-body text-aurora-200 mb-6 font-medium">
              A ANKH é o símbolo da vida eterna, e assim é nossa música - infinita, cíclica, sempre renascendo em novas formas.
            </p>
            <p className="text-body text-aurora-300 font-medium">
